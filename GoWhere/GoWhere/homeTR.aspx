<%@ Page Title="Tourist - Home" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="homeTR.aspx.cs" Inherits="homeTR" Debug ="true"%>
...
<asp:Content ID ="loginUser" ContentPlaceHolderID="loginUser" runat="server">
    ...
    <asp:HyperLink ID="switch" runat="server" NavigateUrl="~/homeTG.aspx"> SWITCH ACCOUNT </asp:HyperLink>
</asp:Content> 
...
<asp:Content ID ="menubarTG" ContentPlaceHolderID="menubar" runat="server">
    <ul>
        <li>
             ...
             <asp:HyperLink ID="homeTourG" runat="server" NavigateUrl="~/homeTR.aspx"> HOME </asp:HyperLink>
       </li>
        <li>
             <img src = "GoWhere/Images/viewProfile.jpg" height = "30" width = "30">
             <asp:HyperLink ID="viewProfileTR" runat="server" NavigateUrl="~/viewTRProfile.aspx"> VIEW PROFILE</asp:HyperLink>
       </li>
       <li>
             <img src = "GoWhere/Images/tour.png" height = "30" width = "30">
             <asp:HyperLink ID="viewT" runat="server" NavigateUrl="~/viewT.aspx"> VIEW TOURS </asp:HyperLink>    
       </li>
       <li>
